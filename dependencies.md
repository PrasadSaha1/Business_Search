...
| **React**       | Used for the website's frontend.                                              |
...
| **Render**      | Used to deploy the backend and frontend. |
| **Railway**     | Used to deploy the PostgreSQL database.                                                                                               |
| **OpenWebNinja**| The API used to get local business data.                                                                                              |


| **Language**    | **Description**                                                                                                                      |
|-----------------|--------------------------------------------------------------------------------------------------------------------------------------|
| **Python**      | Used for the website's backend.                   |
| **JavaScript**  | Used for the frontend with React.                                            |
| **CSS**         | Used to style the frontend.                                             |
